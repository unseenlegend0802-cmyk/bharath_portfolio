  ...
  return (
    <section id="home" className="glow-surface relative overflow-hidden pt-32 pb-20 md:pt-40">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(circle at 50% 50%, color-mix(in oklab, var(--primary) 25%, transparent) 0%, transparent 60%), url(${revathiPhoto})`,
        ...
        <div className="grid grid-cols-2 items-start gap-4 md:items-center md:gap-8 lg:gap-12">
          <div>
            <p className="pill inline-flex px-4 py-1.5 text-xs font-medium tracking-wide">
              Hi! I&apos;m Revathi — based in Telangana, India
            </p>
            ...
            <p className="mt-4 max-w-lg text-sm text-muted-foreground sm:mt-6 sm:text-base">
              Information Technology undergraduate passionate about turning raw data into clear,
              useful insights with Python, SQL, Power BI and machine learning.
            </p>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3 sm:mt-8">
              ...
              <a
                href="/Revathi_resume.pdf"
                download="Revathi_Resume.pdf"
                className="inline-flex items-center gap-2 rounded-full border border-border px-6 py-3 text-sm font-semibold text-foreground transition-colors hover:border-primary hover:text-primary"
              >
            ...
            <div className="mt-6 flex items-center gap-3 sm:mt-8">
              {[
                ...
                { icon: Mail, href: "mailto:revathi9690@gmail.com", label: "Email" },
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:gap-4">
            <div className="card-surface aspect-square w-full max-w-[160px] overflow-hidden rounded-full p-2 sm:max-w-[280px] md:max-w-[360px] lg:max-w-[440px] xl:max-w-[520px]">
              <img
                src={revathiPhoto}
                alt="Revathi — Data Science student and aspiring data analyst"
                width={520}
                height={520}
            ...
            <div className="card-surface w-fit px-3 py-2 text-center sm:px-4 sm:py-3">
              <p className="font-display text-base font-bold text-primary sm:text-xl md:text-2xl">8.03</p>
              <p className="text-[10px] leading-tight text-muted-foreground sm:text-xs">CGPA · B.Tech Data Science</p>
            </div>
          </div>
        </div>
      </div>
